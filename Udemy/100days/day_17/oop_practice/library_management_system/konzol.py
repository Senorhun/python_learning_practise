...
def write_list():
    path_w = 'Udemy/100days/day_17/oop_practice/library_management_system/output.txt'
...
def read_book_from_file():
    path_r = 'Udemy/100days/day_17/oop_practice/library_management_system/input.txt'
